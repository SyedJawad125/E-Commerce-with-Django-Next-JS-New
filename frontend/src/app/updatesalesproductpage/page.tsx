...
const UpdateProduct = () => {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await AxiosInstance.patch(`/ecommerce/salesproduct/?id=${productId}`, formData, {
        headers: {
  ...
  return (
    <div className="container mx-auto px-4 ml-20">
      <h2 className="mt-4 text-2xl font-bold mt-5 mb-10">Update Sales Product Here:</h2>
      <form className="mt-3" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="mt-1 block w-2/4 px-3 py-2 bg-white border border-gray-300 rounded-lg shadow-sm 
            focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-md text-gray-900"
            value={salesprodHasCategory}
            onChange={(e) => setsalesprodHasCategory(e.target.value)}
          >
